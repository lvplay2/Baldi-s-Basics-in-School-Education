...
public class AppLovin
{
	...
	{
		string value = applovinFacade.CallStatic<string>("IsInterstitialReady", new object[2] { currentActivity, zoneId });
		return bool.Parse(value);
	}
	...
	{
		string value = applovinFacade.CallStatic<string>("IsIncentReady", new object[2] { currentActivity, zoneId });
		return bool.Parse(value);
	}
